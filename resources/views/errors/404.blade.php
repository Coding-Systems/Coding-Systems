...
<div class="404_div">
    ...
    <h1 class="center"><span class="label label-danger">Bah alors comme ça on se perd ? Vas-y amuse toi bien !
        <br/>Utilise espace pour tirer et ← → pour bouger. Bonne chance :)</span></h1>
